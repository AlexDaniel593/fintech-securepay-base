/**
 * Factory del controlador de cuentas.
 * Aplica DIP al recibir el servicio de transacciones por constructor.
 */
function createAccountController(transactionService) {
  /**
...
const accountController = createAccountController(transactionService);
accountController.createAccountController = createAccountController;
